...
const Line = () =>{
    return(
        <div>
            <div className="w-[200px] h-[2px] bg-pinkish">
            </div>
        </div>
    );
}
...
const Works = () =>{
    return(
        <div className="max-w-[1920px] mx-auto pl-[50px] pr-[50px]">
            <Navbar/>
            <h1 className="mt-[150px] font-bold text-[32px] text-center">How it <span className="text-pinkish">Works</span></h1>
            <div className="flex justify-center mt-[250px] mb-[200px]">
               
                  
                <div className="w-[300px] h-[200px] bg-pinkish rounded-[10px]">
                        <div className="flex justify-center">
                            <img src="/images/pic15.png" alt="" className="w-[50px] mt-[-40px]"/>
              ...
              <div className="flex items-center">
                ...
                <div className="w-[300px] h-[200px] bg-pinkish rounded-[10px]">
                <div className="flex justify-center">
                            <img src="/images/pic14.png" alt="" className="w-[50px] mt-[-40px]"/>
...
<div className="w-[300px] h-[200px] bg-pinkish rounded-[10px]">
<div className="flex justify-center">
                            <img src="/images/pic13.png" alt="" className="w-[50px] mt-[-40px]"/>
...
<div className="w-[300px] h-[200px] bg-pinkish rounded-[10px]">
<div className="flex justify-center">
                            <img src="/images/pic12.png" alt="" className="w-[50px] mt-[-40px]"/>
