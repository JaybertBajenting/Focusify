    ...
    <div className="flex justify-center items-center">
      <div className="w-[350px] rounded-[10px] bg-white bg-opacity-70">
        <div className="ml-[10px] mr-[10px]">
          ...
          <FaBackwardStep className="w-[50px] h-[25px] cursor-pointer" onClick={handleBack}/>
            ...
            <button onClick={handlePlay}>
              ...
              {isPlaying ? <CiPause1  className="w-[25px] h-[25px] " color="red"/> : <CiPlay1 className="w-[25px] h-[25px]" color="red"/>}
            </button>
            
           
            </div>
            <GiNextButton className="w-[50px] h-[25px] cursor-pointer" onClick={handleNext}/> 
          </div>
          <audio src= {songs[index].url} ref = {audioElem} onDurationChange = {onDurationChangeHandler}/>
        </div>
      </div>

      {/*
        <h1>Music Player</h1> 
        <audio src= "/out.mp3" ref = {audioElem}/>
